  ...
  return (
    <div className='container flex font-[family-name:var(--font-geist-sans)] items-center flex-col justify-center mt-6 gap-6'>
      ...
      <div className="flex items-center">
        ...
        <div className=" cursor-pointer border-t border-b border-r rounded-tr-md rounded-br-md border-secondary-light items-center gap-2 h-[2.8rem] flex py-1.5 px-4">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="1.3em"
            ...
            <input type='text' className='bg-transparent text-sm' placeholder='Search anything with Threadamp AI' />
            <div className="bg-secondary-dark rounded-md py-2 px-2 box-border">
